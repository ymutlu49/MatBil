...
export const CATEGORIES = [
  { id: 'A', name: 'Sanbil (Subitizing)', emoji: '\u{1F441}️', color: COLORS.A, desc: 'Saymadan, bir bakışta sayı tanıma' },
  { id: 'E', name: 'Aritmetik İşlemler', emoji: '➕', color: COLORS.E, desc: 'Sayı komşuları, parça-bütün ve toplama' },
